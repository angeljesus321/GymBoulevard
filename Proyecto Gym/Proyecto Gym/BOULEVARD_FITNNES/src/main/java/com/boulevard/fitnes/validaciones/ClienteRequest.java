...
public class ClienteRequest {
	 @Id
	    ...
	    @NotNull(message = "El tipo de clase no puede estar vacío")
	    public int tipo_claseId;

	    @NotNull(message = "El tipo de membresía no puede estar vacío")
	    public int tipo_membresiaId;

	    @NotNull(message = "El tipo de documento no puede estar vacío")
	    public int tipo_documentoId;
}
